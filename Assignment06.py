...
# C. Halim,2.23.2021,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        return [row for row in list_of_rows if row['Task'].lower() != task.lower()]
...
class IO:
    ...
    def input_task_to_remove():
        task_to_remove = str(input('    Task to remove - ')).strip()
...
while (True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        if strChoice.lower() == "y":
            Processor.write_data_to_file(strFileName, lstTable)  # read file data
